...
const Paper: FC<PaperProps> = ({
  ...
  return (
    ...
    >
      <header className="text-primary w-full min-h-[80px] py-3 border-secondary border-l-[5px] border-solid flex flex-row justify-between items-center px-10">
        <h1 className="font-bold text-title">{title}</h1>
        <a href="/">
          <time
            className="flex flex-row items-center gap-2 text-lg whitespace-nowrap"
